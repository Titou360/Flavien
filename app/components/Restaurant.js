      ...
      <div className="w-5/6 lg:w-full mx-auto my-10 flex flex-row justify-between gap-6 relative">
        <div className="w-2/3 relative mt-32 lg:mt-0 ml-10">
          ...
          <div className="flex flex-row md:flex-col md:gap-10">
            <p className="w-1/2 md:w-full text-black/60 p-4 md:p-0 text-balance md:text-center">
            ...
            <p className="w-1/2 md:w-full text-black/60 p-4 md:p-0 text-balance md:text-center">Une cuisine gourmande, des assiettes joliment dressées pour le plaisirs des papilles de toutes et tous. </p>
          </div>
        </div>
        <div className="flex flex-row justify-start items-end gap-4 absolute inset-0 bottom-7 lg:-bottom-2 z-10 mx-4 md:hidden">

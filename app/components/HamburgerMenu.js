          ...
          <div className="flex flex-col justify-center items-center w-6 h-6 group">
            <span
              className={`block transition-all duration-300 ease-out 
                          h-0.5 w-6 group-hover:w-5 rounded-sm bg-black  ${isOpen ? 'rotate-45 translate-y-1 group-hover:w-8' : '-translate-y-0.5'}`}
            />
            <span
              className={`block transition-all duration-300 ease-out 
                          h-0.5 w-6 group-hover:w-3 rounded-sm my-0.5 bg-black ${isOpen ? 'opacity-0' : 'opacity-100'}`}
            />
            <span
              className={`block transition-all duration-300 ease-out 
                          h-0.5 w-6 group-hover:w-5 rounded-sm bg-black ${isOpen ? '-rotate-45 -translate-y-1 group-hover:w-8' : 'translate-y-0.5'}`}
